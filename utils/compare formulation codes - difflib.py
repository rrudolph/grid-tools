...
xlsx = r"C:\Users\RRudolph\OneDrive - DOI\CHIS Invasives\CHIS_Formulation_Codes_test.xlsx"
...
print("---------- Difflib output -------------")
sys.stdout.writelines(difflib.unified_diff(agol_domains, xlsx_domains, lineterm='\n'))
