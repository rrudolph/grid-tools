...
data_ws = r"C:\GIS\Pro Projects\Rare Plants AGOL Demo\NCI_RarePlants_Sect6_20191117_5C5355FB74154272B234463AEA805B2B_MobileGdbToFileGdb.gdb"

# project_all_fcs(data_ws)

arcpy.env.workspace = 	data_ws

fcs = arcpy.ListFeatureClasses()

for fc in fcs:
	spatial_ref = arcpy.Describe(fc).spatialReference
	print(f"Name: {fc} SR: {spatial_ref.name}")