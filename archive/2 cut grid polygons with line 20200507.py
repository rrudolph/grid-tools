...
cut_dict = {
    "Treat": ws + os.sep + "spatial_join_merge_Treat",
    "No_Target": ws + os.sep + "spatial_join_merge_No_Target",
    "No_Treatment":ws + os.sep + "spatial_join_merge_No_Treatment"
    }
...
for join_type, to_cut in cut_dict.items():
    print("Getting geometry from input")
    finalFC = "FinalMerge_" + join_type
    polygons = get_geom(to_cut, input_id)
